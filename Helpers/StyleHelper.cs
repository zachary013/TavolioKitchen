...
namespace RestoGestApp.Helpers
{
    ...
    public static class StyleHelper
    {
        ...
        // Styles
        public static Style PrimaryButtonStyle => GetStyleResource("PrimaryButton");
        public static Style SecondaryButtonStyle => GetStyleResource("SecondaryButton");
        public static Style SmallButtonStyle => GetStyleResource("SmallButton");
